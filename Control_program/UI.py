...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progresslabel.setGeometry(QtCore.QRect(20, 110, 171, 31))
        self.progresslabel.setObjectName(_fromUtf8("progresslabel"))
        self.progressBar = QtGui.QProgressBar(self.receiver_tab_basic)
        self.progressBar.setGeometry(QtCore.QRect(200, 120, 491, 20))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName(_fromUtf8("progressBar"))
        self.btn_abort = QtGui.QPushButton(self.receiver_tab_basic)
        self.btn_abort.setGeometry(QtCore.QRect(460, 70, 156, 31))
        self.btn_abort.setDefault(False)
        self.btn_abort.setObjectName(_fromUtf8("btn_abort"))
        self.btn_observe = QtGui.QPushButton(self.receiver_tab_basic)
        self.btn_observe.setGeometry(QtCore.QRect(270, 70, 156, 31))
        self.btn_observe.setObjectName(_fromUtf8("btn_observe"))
        self.signal_time_label = QtGui.QLabel(self.receiver_tab_basic)
        self.signal_time_label.setGeometry(QtCore.QRect(20, 10, 101, 17))
        self.signal_time_label.setObjectName(_fromUtf8("signal_time_label"))
        self.ref_time_label = QtGui.QLabel(self.receiver_tab_basic)
        self.ref_time_label.setGeometry(QtCore.QRect(20, 40, 131, 17))
        self.ref_time_label.setObjectName(_fromUtf8("ref_time_label"))
        
        self.sig_time_spinbox = QtGui.QSpinBox(self.receiver_tab_basic)
        self.sig_time_spinbox.setGeometry(QtCore.QRect(160, 10, 48, 27))
        self.sig_time_spinbox.setProperty("value", 5)
        self.sig_time_spinbox.setObjectName(_fromUtf8("sig_time_spinbox"))
        
        self.ref_time_spinBox = QtGui.QSpinBox(self.receiver_tab_basic)
        self.ref_time_spinBox.setGeometry(QtCore.QRect(160, 40, 48, 27))
        self.ref_time_spinBox.setProperty("value", 5)
        self.ref_time_spinBox.setObjectName(_fromUtf8("ref_time_spinBox"))
        
        self.loops_spinbox = QtGui.QSpinBox(self.receiver_tab_basic)
        self.loops_spinbox.setGeometry(QtCore.QRect(160, 70, 48, 27))
        self.loops_spinbox.setProperty("value", 1)
        self.loops_spinbox.setObjectName(_fromUtf8("loops_spinbox"))
        
        self.loops_label = QtGui.QLabel(self.receiver_tab_basic)
        self.loops_label.setGeometry(QtCore.QRect(20, 70, 131, 17))
        self.loops_label.setObjectName(_fromUtf8("loops_label"))
        ...
        self.layoutWidget1 = QtGui.QWidget(self.receiver_tab_advanced)
        ...
        self.mode_switched = QtGui.QRadioButton(self.layoutWidget2)
        ...
        self.autoedit_bad_data_checkBox = QtGui.QCheckBox(self.layoutWidget1)
        ...
        self.LNA_checkbox = QtGui.QCheckBox(self.layoutWidget1)
        ...
        self.noise_checkbox = QtGui.QCheckBox(self.layoutWidget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.signal_time_label.setText(_translate("MainWindow", "Signal time [s]:", None))
        self.ref_time_label.setText(_translate("MainWindow", "Reference time [s]:", None))
        self.loops_label.setText(_translate("MainWindow", "Number of loops:", None))
