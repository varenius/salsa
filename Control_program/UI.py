...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Observebase.setGeometry(QtCore.QRect(20, 40, 791, 581))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 30, 741, 111))
        self.groupBox.setObjectName("groupBox")
        self.objectselector = QtWidgets.QComboBox(self.groupBox)
        self.objectselector.setGeometry(QtCore.QRect(520, 30, 211, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.objectselector.setFont(font)
        self.objectselector.setEditable(False)
        ...
        self.label_5.setGeometry(QtCore.QRect(420, 30, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.btn_GO = QtWidgets.QPushButton(self.groupBox)
        self.btn_GO.setGeometry(QtCore.QRect(290, 30, 121, 31))
        self.btn_GO.setMaximumSize(QtCore.QSize(16777215, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.btn_GO.setFont(font)
        self.btn_GO.setStyleSheet("font-size: 13pt;")
        self.btn_GO.setObjectName("btn_GO")
        self.label_6 = QtWidgets.QLabel(self.groupBox)
        self.label_6.setGeometry(QtCore.QRect(420, 70, 221, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.distance = QtWidgets.QLineEdit(self.groupBox)
        self.distance.setGeometry(QtCore.QRect(650, 70, 81, 31))
        self.distance.setReadOnly(True)
        self.distance.setObjectName("distance")
        self.ez_telstatus = QtWidgets.QLineEdit(self.groupBox)
        self.ez_telstatus.setGeometry(QtCore.QRect(160, 30, 111, 31))
        self.ez_telstatus.setReadOnly(True)
        self.ez_telstatus.setObjectName("ez_telstatus")
        self.ez_telstatus_label = QtWidgets.QLabel(self.groupBox)
        self.ez_telstatus_label.setGeometry(QtCore.QRect(0, 30, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.ez_telstatus_label.setFont(font)
        self.ez_telstatus_label.setObjectName("ez_telstatus_label")
        self.groupBox_2 = QtWidgets.QGroupBox(self.tab_Observe)
        self.groupBox_2.setGeometry(QtCore.QRect(20, 140, 741, 411))
        self.groupBox_2.setObjectName("groupBox_2")
        self.label_14 = QtWidgets.QLabel(self.groupBox_2)
        self.label_14.setGeometry(QtCore.QRect(10, 20, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.label_14.setFont(font)
        self.label_14.setObjectName("label_14")
        self.obs_time_ez = QtWidgets.QSpinBox(self.groupBox_2)
        self.obs_time_ez.setGeometry(QtCore.QRect(186, 20, 61, 30))
        ...
        self.btn_start_obs_ez.setGeometry(QtCore.QRect(250, 20, 51, 31))
        self.btn_start_obs_ez.setObjectName("btn_start_obs_ez")
        self.btn_stop_obs_ez = QtWidgets.QPushButton(self.groupBox_2)
        self.btn_stop_obs_ez.setGeometry(QtCore.QRect(310, 20, 51, 31))
        self.btn_stop_obs_ez.setObjectName("btn_stop_obs_ez")
        self.groupBox_spectrum_ez = QtWidgets.QGroupBox(self.groupBox_2)
        self.groupBox_spectrum_ez.setGeometry(QtCore.QRect(10, 60, 721, 341))
        self.groupBox_spectrum_ez.setObjectName("groupBox_spectrum_ez")
        self.progressBar_ez = QtWidgets.QProgressBar(self.groupBox_2)
        self.progressBar_ez.setGeometry(QtCore.QRect(369, 20, 361, 31))
        self.progressBar_ez.setProperty("value", 0)
        self.progressBar_ez.setObjectName("progressBar_ez")
        self.btn_webcam = QtWidgets.QPushButton(self.tab_Observe)
        self.btn_webcam.setGeometry(QtCore.QRect(590, 0, 191, 31))
        font = QtGui.QFont()
        ...
        self.btn_unfreeze = QtWidgets.QPushButton(self.layoutWidget)
        self.btn_unfreeze.setEnabled(True)
        self.btn_unfreeze.setObjectName("btn_unfreeze")
        self.gridLayout.addWidget(self.btn_unfreeze, 4, 3, 1, 1)
        ...
        self.telstatus = QtWidgets.QLineEdit(self.groupBox_tc)
        self.telstatus.setGeometry(QtCore.QRect(620, 0, 101, 21))
        self.telstatus.setReadOnly(True)
        self.telstatus.setObjectName("telstatus")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 10, 582, 41))
        ...
        self.label_mode.setGeometry(QtCore.QRect(21, 108, 131, 16))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(300, 16, 259, 101))
        ...
        self.noise_checkbox.setCheckable(False)
        ...
        self.ChannelsInput.addItem("")
        self.ChannelsInput.addItem("")
        self.gain = QtWidgets.QSpinBox(self.receiver_tab_advanced)
        self.gain.setGeometry(QtCore.QRect(180, 170, 71, 24))
        self.gain.setMaximum(60)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(596, 0, 179, 32))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.vel_or_freq_group = QtWidgets.QHBoxLayout(self.layoutWidget4)
        self.vel_or_freq_group.setContentsMargins(0, 0, 0, 0)
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(400, 0, 187, 31))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.log_and_norm_group = QtWidgets.QHBoxLayout(self.layoutWidget_2)
        self.log_and_norm_group.setContentsMargins(0, 0, 0, 0)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(0, 20, 2, 2))
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(0, 20, 2, 2))
        self.layoutWidget7.setObjectName("layoutWidget7")
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.layoutWidget7)
        self.horizontalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.clock = QtWidgets.QLineEdit(self.centralwidget)
        self.clock.setGeometry(QtCore.QRect(630, 40, 181, 21))
        self.clock.setReadOnly(True)
        self.clock.setObjectName("clock")
        self.label_clock = QtWidgets.QLabel(self.centralwidget)
        self.label_clock.setGeometry(QtCore.QRect(580, 40, 41, 21))
        self.label_clock.setObjectName("label_clock")
        self.languageselector = QtWidgets.QComboBox(self.centralwidget)
        self.languageselector.setGeometry(QtCore.QRect(480, 40, 91, 23))
        ...
        self.label_language.setGeometry(QtCore.QRect(400, 40, 81, 21))
        ...
        self.Observebase.setCurrentIndex(1)
        self.tabWidget_2.setCurrentIndex(0)
        self.BandwidthInput.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Please: When finished, choose Target=Stow and press \"GO\" to put telescope in stow position. "))
        self.groupBox.setTitle(_translate("MainWindow", "Tracking"))
        self.objectselector.setCurrentText(_translate("MainWindow", "Galactic (100,0)"))
        self.objectselector.setItemText(0, _translate("MainWindow", "Galactic (100,0)"))
        self.objectselector.setItemText(1, _translate("MainWindow", "Galactic (140,0)"))
        self.objectselector.setItemText(2, _translate("MainWindow", "Satellite C05"))
        self.objectselector.setItemText(3, _translate("MainWindow", "The Sun"))
        self.objectselector.setItemText(4, _translate("MainWindow", "Stow"))
        self.label_5.setText(_translate("MainWindow", "Target:"))
        self.btn_GO.setText(_translate("MainWindow", "Move to"))
        self.label_6.setText(_translate("MainWindow", "Angle to target [degrees]:"))
        self.ez_telstatus_label.setText(_translate("MainWindow", "Telescope status:"))
        ...
        self.btn_stop_obs_ez.setText(_translate("MainWindow", "Cancel"))
        self.groupBox_spectrum_ez.setTitle(_translate("MainWindow", "Spectrum"))
        self.btn_webcam.setText(_translate("MainWindow", "Open live webcam"))
        self.Observebase.setTabText(self.Observebase.indexOf(self.tab_Observe), _translate("MainWindow", "Simple"))
        self.groupBox_tc.setTitle(_translate("MainWindow", "Telescope movement control                         Telescope status:"))
        ...
        self.inputleftcoord.setText(_translate("MainWindow", "100"))
        ...
        self.btn_unfreeze.setText(_translate("MainWindow", "Unfreeze"))
        ...
        self.label_gain.setText(_translate("MainWindow", "USRP gain [dB]"))
        ...
        self.BandwidthInput.setItemText(0, _translate("MainWindow", "1.0"))
        self.BandwidthInput.setItemText(1, _translate("MainWindow", "2.5"))
        self.BandwidthInput.setItemText(2, _translate("MainWindow", "5.0"))
        self.BandwidthInput.setItemText(3, _translate("MainWindow", "10.0"))
        self.BandwidthInput.setItemText(4, _translate("MainWindow", "25.0"))
        ...
        self.languageselector.setItemText(0, _translate("MainWindow", "English"))
        self.languageselector.setItemText(1, _translate("MainWindow", "Svenska"))
