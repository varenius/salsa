...
\begin{itemize}
	\item{\emph{Gratisprogrammet NoMachine.} Detta är det vanligaste
			...
			observationer så behöver du ladda hem programmet från \newline
...
\item{\emph{Terminalen.} Om du är van att arbeta i terminalen så kan du 
		...
		{\tt ssh -X username@computer}.  Du kan sedan starta kontrollprogrammet
...
klicka på \emph{x} i hörnet av NoMachine-fönstret) och sedan välja 
...
\subsubsection{SalsaJ - Gratis grafisk mjukvara}
