...
%Aside from direct inspection in the control
%program, the most common way to process the data is by using Matlab to read the
%FITS files, see below.
...
\subsubsection{SalsaJ - Free graphical software}
